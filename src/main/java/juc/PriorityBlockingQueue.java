...
public class PriorityBlockingQueue<E> extends AbstractQueue<E>
    ...
    public PriorityBlockingQueue(Collection<? extends E> c) {
        ...
        if (c instanceof SortedSet<?>) {
            ...
            heapify = false;
        } else if (c instanceof juc.PriorityBlockingQueue<?>) {
            juc.PriorityBlockingQueue<? extends E> pq =
                    (juc.PriorityBlockingQueue<? extends E>) c;
            this.comparator = (Comparator<? super E>) pq.comparator();
            screen = false;
            if (pq.getClass() == juc.PriorityBlockingQueue.class) // exact match
                heapify = false;
        }
        Object[] a = c.toArray();
        int n = a.length;
    ...
    static final class PBQSpliterator<E> implements Spliterator<E> {
        final juc.PriorityBlockingQueue<E> queue;
        Object[] array;
        int index;
        int fence;

        PBQSpliterator(juc.PriorityBlockingQueue<E> queue, Object[] array,
                       int index, int fence) {
            this.queue = queue;
            this.array = array;
            this.index = index;
